...
return {
    ...
    s({ trig = ":p", snippetType = "autosnippet" }, t("\\varpi"), { condition = in_mathzone }),
    s({ trig = ":q", snippetType = "autosnippet" }, t("\\vartheta"), { condition = in_mathzone }),
    s({ trig = ":r", snippetType = "autosnippet" }, t("\\varrho"), { condition = in_mathzone }),
    s({ trig = ":s", snippetType = "autosnippet" }, t("\\varsigma"), { condition = in_mathzone }),
    ...
    s({ trig = "@p", snippetType = "autosnippet" }, t("\\pi"), { condition = in_mathzone }),
    s({ trig = "@q", snippetType = "autosnippet" }, t("\\theta"), { condition = in_mathzone }),
